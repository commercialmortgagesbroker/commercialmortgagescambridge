...
export const metadata: Metadata = {
  title: `Commercial Mortgages Cambridge | Specialist Cambridge Commercial Mortgage Broker`,
  description:
    "Commercial mortgages in Cambridge from a specialist commercial mortgage broker. Owner-occupier, life sciences and lab investment, semi-commercial, portfolio refinance and trading-business commercial mortgages placed across a 90-plus lender panel, including Cambridge & Counties Bank. Indicative terms in 48 hours, mid-2026 Cambridge commercial mortgage rates 6.0 to 9.0% pa.",
