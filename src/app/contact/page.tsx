...
const contactFaqs = [
  ...
  {
    question: "Do you cover the whole Greater Cambridge area?",
    answer:
      'Yes. The full Cambridge City boundary and Greater Cambridge footprint (including <a href="/areas/city-centre">Cambridge City Centre and King\'s Parade</a>, <a href="/areas/hills-road-triangle">Hills Road and The Triangle</a>, <a href="/areas/mill-road">Mill Road</a>, <a href="/areas/cambridge-biomedical-campus">Cambridge Biomedical Campus</a>, <a href="/areas/cambridge-science-park">Cambridge Science Park</a>, <a href="/areas/newmarket-road">Newmarket Road</a>, <a href="/areas/chesterton">Chesterton and Cambridge North</a>, <a href="/areas/trumpington-south">Trumpington and Cambridge South</a>) plus the life-sciences belt out to Granta Park, Babraham Research Campus and Histon, and the wider Cambridgeshire footprint.',
  },
  {
    question: "What loan sizes do you work on?",
    answer:
      "Commercial mortgage facilities from \u00a3150K to \u00a310M and beyond on Cambridge life-sciences investment lots. Smaller deals below \u00a3150K are typically better served by high-street SME products; we can still refer those where appropriate.",
  },
];
                ...
                <div>
                  ...
                  <div className="mt-6 space-y-4">
                    ...
                    <div>
                      ...
                      <p className="text-base text-gray-700">
                        Full Cambridge City and Greater Cambridge,
                        life-sciences belt out to Granta Park, Babraham and
                        Histon, wider Cambridgeshire.
                      </p>
                    </div>
                  </div>
                </div>
