...
export const metadata: Metadata = {
  ...
  description: `Real ${loc} commercial mortgage case studies, owner-occupier, investment, semi-commercial, trading-business and portfolio refinance deals across Cambridge Biomedical Campus, Cambridge Science Park, Hills Road, Mill Road, Newmarket Road, Newnham and Chesterton.`,
