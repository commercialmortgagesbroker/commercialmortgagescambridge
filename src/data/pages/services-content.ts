/**
 * /services hub page content, Commercial Mortgages Cambridge.
 *
 ...
 * NeuronWriter target ~652 words for the `commercial mortgage broker cambridge`
...
export const servicesContent: ServicesContent = {
  hero: {
    h1: "Commercial Mortgage Broker Cambridge, 90+ Lenders",
    lede:
  ...
  mapIntro: {
    h2: "Where the deals are placed across Cambridge and Cambridgeshire",
    body:
      'From the <a href="/areas/city-centre" class="text-secondary font-medium hover:underline">CB1 CBD</a> office investment market through the <a href="/areas/newmarket-road" class="text-secondary font-medium hover:underline">Newmarket Road</a> creative-office estate, the <a href="/areas/cambridge-science-park" class="text-secondary font-medium hover:underline">Cambridge Science Park</a> and <a href="/areas/petersfield" class="text-secondary font-medium hover:underline">Petersfield</a> semi-commercial parades, the <a href="/areas/cherry-hinton" class="text-secondary font-medium hover:underline">Cherry Hinton</a> and Trumpington care-home cluster, and the <a href="/areas/cherry-hinton" class="text-secondary font-medium hover:underline">Cherry Hinton</a> and Histon industrial belt. Use the map below to see live placement activity across the City of Cambridge.',
  },
  ...
  services: [
    {
      ...
      paragraphs: [
        "When the business buys the building it trades from, the lending test is <strong>EBITDA cover</strong>, trading profit measured against the monthly mortgage payment, with a typical comfort threshold of 1.3–1.5×. This is the dental partnership taking the CB2 surgery freehold off a retiring principal; the accountancy firm converting a Hills Road lease into a floor purchase; the engineering business buying its Histon trade-counter unit off the landlord. Two years of clean filed accounts is the standard minimum. LTV runs to <strong>75%</strong>, deposits of 25–30% are typically funded from accumulated retained profit (and occasionally capital-released equity from a director's home).",
        '<strong>Allica Bank</strong>, <strong>Shawbrook</strong>, HTB (dedicated Cambridge office), Cambridge & Counties and <strong>Cynergy Bank</strong> sit at the sweet spot for owner-occupier lending. <strong>Lloyds</strong> commercial banking, <strong>NatWest</strong> St Andrew\'s Street, <strong>Barclays</strong> Hills Road and <strong>Santander</strong> price competitively where the covenant is strong and the sector is mainstream. Mid-2026 interest rates: <strong>6.0–7.5% pa</strong>. Term length is the lever that materially changes affordability, extending repayment from 15 to 20 years frequently clears the EBITDA test where rate alone will not. Owner-occupier sits outside FCA regulation in most cases (it is a business borrowing for business premises, not a residential mortgage).',
        'Sectors with the deepest lender appetite in Cambridge: dental and GP practices (the CB2 Trumpington cluster is a recognised sub-market), accountancy, legal and other professional services, light industrial and trade-counter (Histon, Cambridge North fringe, Cambridge Research Park Waterbeach) and pharmacy. Sector-specialist trades, care home, MOT, day nursery, route through <a href="/services/trading-business-mortgage" class="text-secondary font-medium hover:underline">trading-business mortgages</a> instead.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Tenant covenant and lease length carry as much weight as LTV. A 10-year unbroken FRI lease to a national covenant on a Cambridge Science Park office prices materially better than three two-year leases to local independents on a secondary parade. <strong>NatWest</strong>, <strong>Lloyds</strong>, <strong>Barclays</strong> and <strong>Santander</strong> compete hard on prime single-asset investment; <strong>Shawbrook</strong>, <strong>InterBay Commercial</strong>, <strong>LendInvest</strong> and Together cover the trickier end (multi-let, short-WAULT, semi-commercial, vacant-with-refurb). Interest rates currently <strong>6.5–8.5% pa</strong>.',
        'Active areas: <a href="/areas/city-centre" class="text-secondary font-medium hover:underline">city-centre office and retail</a>, <a href="/areas/cambridge-science-park" class="text-secondary font-medium hover:underline">Cambridge Science Park</a> semi-commercial parades, <a href="/areas/newmarket-road" class="text-secondary font-medium hover:underline">Newmarket Road Urban Village</a> creative offices, and the Histon/Cambridge North fringe industrial belt.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        'Semi-commercial finance funds mixed-use property where the residential element is at least 40% of total floorspace, the classic shop-with-flat-above archetype that defines Cambridge high streets like <a href="/areas/cambridge-science-park" class="text-secondary font-medium hover:underline">Mill Road</a> in CB1, Hills Road in <a href="/areas/petersfield" class="text-secondary font-medium hover:underline">Petersfield</a>, Chesterton Road in <a href="/areas/chesterton" class="text-secondary font-medium hover:underline">Chesterton</a> and Newnham Road in <a href="/areas/cherry-hinton" class="text-secondary font-medium hover:underline">Cherry Hinton</a>. The flat above gives lenders residential security comfort, so semi-commercial routinely prices 50–100bps inside pure commercial investment.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '<strong>Shawbrook</strong>, Cambridge & Counties, <strong>InterBay Commercial</strong> and <strong>Cynergy Bank</strong> are the most active portfolio lenders for the £2M–£15M Cambridge bracket. OakNorth and Reliance Bank cover larger facility sizes. Aggregate ICR is tested across the portfolio at <strong>140–150%</strong>; tenant concentration matters (more than 20–25% of income from one tenant tightens pricing); sector concentration matters; Cambridgeshire geographic concentration is fine.',
    ...
    },
    {
      ...
      paragraphs: [
        'Trading-business mortgages fund operational property where value is bound up with the business that runs from it. Pubs on Mill Lane and the Ely market spine; hotels on Hills Road and around Cambridge Science Park; care homes in <a href="/areas/cherry-hinton" class="text-secondary font-medium hover:underline">Cherry Hinton</a>, Trumpington and Bar Hill; MOT and petrol forecourts in Cherry Hinton, Histon and outer Cambridge; day nurseries in Cambridge Science Park, Cherry Hinton and Newnham; dental practices across the Trumpington CB2 cluster; B&Bs around Ely and the Mill Road fringe.',
        'Underwriting is sector-specific. <strong>Pubs</strong>: barrelage, EBITDA, beer-tie status, license, <strong>Cynergy Bank</strong> and ASK Partners dominate. <strong>Hotels</strong>: occupancy, ADR, RevPAR. <strong>Care homes</strong>: CQC rating, occupancy, weighted-average bed value, council/private fee mix, <strong>Shawbrook</strong>, Cambridge & Counties and Hampshire Trust hold significant Cambridge books. <strong>Dental</strong>: NHS UDA value plus private fee mix. <strong>MOT</strong>: VOSA approval, environmental due diligence. <strong>Nursery</strong>: Ofsted rating, registered places, occupancy.',
    ...
    },
    {
      ...
      paragraphs: [
        'Commercial remortgage covers two distinct moments. End of a typical 5-year fix maturing into a different rate environment; or capital-raise refinancing that releases equity from a property that has appreciated since the original draw. With Bank of England base-rate trajectory through 2026 looking flatter than the 2023–24 cycle, refinancing demand into Cambridge is strong, particularly on assets bought 2019–2021 where current valuations support a meaningfully better LTV than the original facility.',
        ...
        'For end-of-fix the underwriting story is usually clean, known asset, known borrower, known track record. <strong>NatWest</strong>, <strong>Lloyds</strong>, <strong>Barclays</strong>, <strong>Santander</strong>, <strong>Shawbrook</strong>, Allica, HTB Cambridge, Cambridge & Counties and <strong>InterBay Commercial</strong> all compete on clean Cambridge remortgage business. Pricing for owner-occupier remortgage at 65% LTV on a strong covenant: <strong>6.0–7.5% pa</strong>. Investment remortgage 6.5–8.5% pa.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '<strong>LendInvest</strong>, <strong>Shawbrook</strong>, Together, OakNorth and Hampshire Trust Bank are the most active commercial bridging desks for the Cambridge £500K–£5M bracket. Bridge interest rates currently run <strong>0.70–0.95% pm</strong> (8.5–11.5% pa equivalent); term-out pricing back to mainstream <strong>6.5–8.5% pa</strong> once the property stabilises and the ICR test passes. Interest can be serviced monthly or rolled-up; LTVs to 70% on current value, sometimes 75% on day-one purchase price plus 100% of refurb costs against GDV.',
        'Where this works particularly well in Cambridge: vacant CB1 office floorplates being refurbished for re-letting; semi-commercial conversions (shop+flat-above stock being upgraded); industrial units bought from receivers; trading businesses bought as going concerns where the new operator needs 12 months of accounts before a high-street remortgage will engage.',
      ],
    ...
    },
    {
      ...
      paragraphs: [
        ...
        '<strong>InterBay Commercial</strong>, Together, United Trust Bank and select private-credit desks are the active second-charge commercial lenders for Cambridge. Pricing reflects subordinated risk: <strong>10–14% pa</strong> typically, arrangement fees of 2–3%. Combined LTV (first plus second) usually capped at <strong>70–75%</strong>, occasionally flexed to 80% on strong investment cases.',
  ...
  networkBand: {
    ...
    paragraphs: [
      ...
      "Owner-occupier in Manchester, portfolio refinancing across East of England and the Midlands, a trading-business mortgage in Newcastle, or a commercial remortgage on a Bristol office, the same panel, the same diagnostic process, the same unregulated commercial product set.",
    ],
  },

  finalCta: {
    h2: "Which product fits your Cambridge deal?",
    body:
