/**
 * Per-service deep-dive content, Commercial Mortgages Cambridge.
 *
 ...
 *
 * Voice rules:
 *   - "we" not "I"; no em dashes; no marketing cliches
 *   - rate band 6.0 to 9.0% pa for mid-2026
 *   - only eight named lenders bolded: Shawbrook, InterBay Commercial,
 *     LendInvest, Cynergy Bank, Lloyds, NatWest, Barclays, Santander.
 *   - Cambridge & Counties Bank named but NOT bolded.
 *   - broker not FCA-authorised; never claim authorisation
 *
...
export const serviceDetails: Record<string, ServiceDetail> = {
  "owner-occupier-commercial-mortgage": {
    ...
    metaTitle: "Owner-Occupier Commercial Mortgage Cambridge | Specialist Broker",
    metaDescription:
      "Owner-occupied commercial mortgages in Cambridge and Cambridgeshire. Up to 75% LTV, EBITDA cover at 1.3 to 1.5x, interest rates from 6.0% pa, 5 to 25 year repayment terms. Cambridge & Counties Bank, Shawbrook, Lloyds, NatWest, Barclays, Santander. Indicative terms in 48 hours.",
    hero: {
      eyebrow: "Up to 75% LTV · EBITDA-driven",
      h1: "Owner-Occupier Commercial Mortgage Cambridge",
      lede:
        "Long-term debt funding the purchase of the property your business trades from. Up to 75% loan-to-value. EBITDA cover at 1.3 to 1.5x. Interest rates 6.0 to 7.5% pa for strong covenants. 5 to 25 year repayment terms. Active across life sciences SMEs at Cambridge Science Park, Cambridge Biomedical Campus ancillary occupiers, professional services on Hills Road and Sidney Street, and Mill Road independents.",
      metrics: [
    ...
    whatItIs: {
      ...
      body: [
        'An owner-occupier commercial mortgage is long-term secured debt funding the purchase of the property your <strong>business trades from</strong>: your life sciences SME unit on Cambridge Science Park, your professional services freehold on Hills Road or Sidney Street, your dental practice off Trumpington Road, your independent on Mill Road, or your light industrial unit on the Newmarket Road trade belt. The lender takes a first charge over the building; you fund a deposit (typically 25 to 30%); the facility is amortised over 15 to 25 years on monthly capital-and-interest repayments. Most owner-occupier deals are taken out by a <strong>limited company</strong> trading entity with a personal guarantee from the directors, though sole traders, partnerships and LLPs are equally accommodated.',
        'The lending test is fundamentally different from an investment mortgage. Where investment lenders test rent against interest cost (ICR), owner-occupier lenders test <strong>EBITDA cover</strong>: trading profit (earnings before interest, tax, depreciation and amortisation) measured against the mortgage payment, with a typical comfort threshold of <strong>1.3 to 1.5x</strong>. Two years of clean filed accounts is the standard minimum, though specialist desks flex this for established sectors (dental, GP, pharmacy, regulated life sciences) on 12 to 18 months trading.',
        'It is also different from a <strong>residential mortgage</strong>, and that distinction matters legally. Owner-occupier commercial lending falls largely outside FCA-regulated mortgage rules, because the borrower is a business buying business premises (not an individual buying a home). The exception: where a sole trader uses the property partly as a residence, the deal can fall into FCA-regulated territory; we flag that at outset. For limited company borrowers buying B-class or E-class commercial stock, the deal is unregulated commercial lending.',
        'In Cambridge the typical owner-occupier facility size is <strong>£250K to £5M</strong>, with the bulk of volume in the £600K to £2M bracket given how firmly the local commercial market prices. Lab-enabled and life sciences freeholds around Cambridge Science Park, St John\'s Innovation Park and the Cambridge Biomedical Campus fringe routinely trade at £1.5M to £4M. LTVs of 70 to 75% are routine for established businesses. Interest rates currently <strong>6.0 to 7.5% pa</strong> for strong covenants, stretching to 9.0% on tighter cases. Term length is the most useful affordability lever; extending repayment from 15 to 20 years often clears the EBITDA test where rate alone will not. Stamp duty (SDLT) on commercial purchase applies up to 5% on the slice above £250,000; we factor it into the deposit-and-fees model before submission. <em>Indicative case seed:</em> a Cambridge Science Park-adjacent life sciences SME acquiring a 6,000 sq ft lab-enabled unit at £2.4M needs roughly £600K deposit plus £107K SDLT plus professional fees, against a £1.8M facility at 6.5% over 20 years.',
      ],
    },
    howItWorks: {
      h2: "Lender appetite and rates for owner-occupier deals across Cambridgeshire",
      steps: [
        ...
        { label: "4. RICS Red Book valuation", detail: "Critical-path item, typically 2 to 3 weeks. The lender instructs from a panel; valuation comments on bricks-and-mortar value and any specialist sector overlay (lab fit-out, healthcare use)." },
    ...
    whoItsFor: {
      h2: "Sectors where Cambridge owner-occupier lending is deepest",
      items: [
        "Life sciences and deep-tech SMEs acquiring lab-enabled freeholds at Cambridge Science Park, St John\'s Innovation Park, Cambridge Research Park and the fringe of the Cambridge Biomedical Campus",
        "Professional services firms buying their Hills Road, Sidney Street or St Andrew\'s Street office (accountancy, legal, consultancy, IP and patent attorneys serving the cluster)",
        "Dental and primary-care principals buying freehold (Trumpington Road, Hills Road clinics, Mill Road and Chesterton parade dental practices)",
        "Independent retailers and F&B operators buying their Mill Road, King\'s Parade or Sidney Street unit",
        "Light industrial and trade-counter businesses on the Newmarket Road belt and the Cherry Hinton industrial fringe",
        "Health and wellness operators (physio, opticians, vets) acquiring premises across the CB-postcode suburbs",
        "Professional services partnerships transitioning from leasehold to freehold on a Hills Road Victorian conversion ahead of a partner buy-out",
        "Tech and software SMEs on the cluster fringe acquiring office and workshop freeholds in Chesterton, Trumpington and the inner CB4 ring",
      ],
    },
    localAngle: {
      h2: "Why Cambridge has unusually defensible owner-occupier capacity",
      body: 'Cambridge is the UK\'s most concentrated life sciences and tech commercial market, anchored by the University of Cambridge, Addenbrooke\'s and the Cambridge University Hospitals NHS Trust at the Cambridge Biomedical Campus, AstraZeneca\'s Discovery Centre, Cambridge Science Park (Trinity College, the UK\'s longest-established science park), Granta Park and Babraham Research Campus. The city has roughly 145,000 residents and a metro working-age population approaching 290,000, with a younger skew driven by ~24,000 University of Cambridge students and ~30,000 at Anglia Ruskin. That demand pattern, combined with structurally low vacancy and constrained new commercial supply, holds rents and yields firmer than the regional UK average and supports unusually defensible bricks-and-mortar values on owner-occupier purchases. Cambridge & Counties Bank, headquartered locally and historically concentrated in East Anglia and the Midlands, runs an active owner-occupier programme on the city it calls home; <strong>Shawbrook</strong>, <strong>Cynergy Bank</strong>, <strong>InterBay Commercial</strong> and <strong>LendInvest</strong> all run active East Anglia programmes; the clearing banks <strong>Lloyds</strong> (Sidney Street), <strong>NatWest</strong> (Sidney Street), <strong>Barclays</strong> (St Andrew\'s Street) and <strong>Santander</strong> all field commercial desks competing on cleaner owner-occupier cases up to around £5M. Sector clusters worth noting: lab-enabled life sciences freeholds around <a href="/areas/" class="text-secondary font-medium hover:underline">Cambridge Science Park and St John\'s Innovation Park</a>, professional services on Hills Road and Sidney Street, dental and primary care around Trumpington Road and the Addenbrooke\'s flank, and independent retail along <a href="/property-types/retail" class="text-secondary font-medium hover:underline">Mill Road and the King\'s Parade tourist spine</a>. Refinancing volume is particularly strong on assets bought 2019 to 2021 where current valuations support a meaningfully better LTV than the original draw.',
    },
    faqs: [
      {
        question: "How much can I borrow against my Cambridge business premises?",
        answer:
          'Typically up to <strong>75% loan-to-value</strong>, capped by the <strong>EBITDA cover test</strong> (1.3 to 1.5x). For a £1.5M property at 75% LTV that is a £1.125M facility; you need EBITDA covering the mortgage repayment by ~1.4x. Use our <a href="/calculator">commercial mortgage calculator</a> to model scenarios across rate and term.',
      },
      {
        question: "What deposit will I need?",
        answer:
          'Typically <strong>25 to 30%</strong>, normally funded from accumulated retained profit inside the limited company or from a director loan. Some specialist desks consider 80% LTV (20% deposit) for very strong covenants in defensive sectors (dental, GP, pharmacy, regulated life sciences), but the interest rate steps up to compensate.',
      },
      {
      ...
      },
      {
        ...
        answer:
          'Stamp duty land tax (SDLT) on commercial property purchase runs at 0% on the slice up to £150K, 2% from £150K to £250K, and 5% above £250K. On a £1.5M Cambridge business premises the SDLT bill is around £64,500. We factor it into your deposit-and-fees model so there are no surprises at completion.',
      },
      {
  ...
  "commercial-investment-mortgage": {
    ...
    metaTitle: "Commercial Investment Mortgage Cambridge | Specialist Broker",
    metaDescription:
      "Commercial investment mortgages in Cambridge for let property held for income. Up to 75% LTV, ICR 140 to 160%, interest rates from 6.5% pa, 5 to 25 year repayment terms. Limited company SPV structures. NatWest, Lloyds, Shawbrook, InterBay Commercial, LendInvest.",
    hero: {
      eyebrow: "Up to 75% LTV · ICR-led",
      h1: "Commercial Investment Mortgage Cambridge",
      lede:
        "Long-term mortgages secured against income-producing commercial property: lab and office investment, central retail, Newmarket Road hotels and mixed-use. Up to 75% loan-to-value. Interest cover ratio test 140 to 160% stressed. Interest rates 6.5 to 8.5% pa. 5 to 25 year repayment terms. Limited company SPV, LLP and individual structures all supported.",
      metrics: [
        { label: "LTV", value: "Up to 75%" },
    ...
    whatItIs: {
      ...
      body: [
        'A commercial investment mortgage is long-term debt secured against a <strong>let commercial property</strong> held as an income-producing asset. The borrower is typically a <strong>limited company</strong> SPV (the dominant structure for new acquisitions across the Cambridge market), an LLP, or an individual investor; the security is the property; the affordability test is rent against the cost of borrowing. Unlike a residential buy-to-let mortgage, which tests personal income and rental yield against ASTs, commercial investment underwrites against business tenancies on FRI (full repairing and insuring) leases.',
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { label: "4. RICS Red Book valuation", detail: "Includes market rent assessment and estimated rental value (ERV), both important to the underwrite. Typically 2 to 3 weeks." },
    ...
    whoItsFor: {
      h2: "Investor profiles we routinely place across Cambridge",
      items: [
        "Lab and office investment buyers on Cambridge Biomedical Campus, Cambridge Science Park, Granta Park and Babraham Research Campus",
        "Central retail investors on Sidney Street, the Grand Arcade catchment, Lion Yard and Petty Cury",
        "Newmarket Road hotel and roadside hospitality investors backing the tourism economy (~8 million annual visitors)",
        "Mill Road and Romsey independent F&B and retail investment buyers",
        "Cherry Hinton and Chesterton multi-let industrial investors on the city fringe",
    ...
    localAngle: {
      h2: "Where Cambridge commercial investment volume actually sits",
      body: 'Cambridge runs one of the firmest regional commercial investment markets in the UK: structurally low vacancy, rents and yields that hold up firmer than the regional UK average, and a deal flow dominated by lab and office investment around <a href="/areas/" class="text-secondary font-medium hover:underline">Cambridge Biomedical Campus, Cambridge Science Park, Granta Park and Babraham Research Campus</a>, central retail on Sidney Street, the Grand Arcade catchment and Lion Yard, and Newmarket Road hotels. The £500K to £3M bracket is the deep volume zone for smaller landlords: parade retail on Mill Road and the Chesterton high street, semi-commercial blocks across Romsey and Petersfield, and central upper-floor mixed-use throughout the CB1 and CB2 ring. The £3M to £15M+ bracket is where the lab and office investment flow sits, particularly around the CSP and CBC clusters. Lab investment yields currently sit firmer than the wider UK regional office market, reflecting structural demand from the life sciences cluster. Interest rates currently <strong>6.5 to 8.5% pa</strong> depending on covenant and LTV. Cambridge & Counties Bank, Cambridge-headquartered, runs an active local commercial investment programme particularly on £500K to £3M deals; <strong>Shawbrook</strong>, <strong>InterBay Commercial</strong>, <strong>Cynergy Bank</strong>, <strong>LendInvest</strong>, <strong>NatWest</strong>, <strong>Lloyds</strong>, <strong>Barclays</strong> and <strong>Santander</strong> all compete on Cambridge <a href="/property-types/" class="text-secondary font-medium hover:underline">commercial investment cases</a>.',
    },
    faqs: [
      {
        question: "What ICR do Cambridge investment lenders typically require?",
        answer:
          'Typically <strong>140 to 160%</strong>, stressed at a notional interest rate 1 to 2% above pay rate. Strong-covenant single-let assets price at the lower-cover end (140%); multi-let or short-lease assets at the higher end (155 to 160%). Some specialist desks will flex to 130% for prime Cambridge Science Park or Cambridge Biomedical Campus stock with an unbroken 10+ year lease to an investment-grade life sciences tenant.',
      },
      {
      ...
      {
        question: "What interest rate should I expect on a Cambridge commercial investment mortgage?",
        answer:
          'Currently <strong>6.5 to 8.5% pa</strong>. The drivers: covenant strength, lease length, loan-to-value, asset class. A 10-year FRI lease to a national life sciences covenant on a CSP office at 60% LTV prices best (~7.0%); a multi-let secondary asset at 75% LTV prices wider (~8.5%). 5-year fixes typically price 0.25 to 0.50% above 2-year fixes.',
      },
      {
        question: "Do you handle limited company SPV structures?",
        answer:
          'Yes, limited company SPV holding is the standard structure for commercial investment across Cambridge. We work with both new SPVs (with personal guarantee from the principal) and existing trading limited companies. Individual investor structures and LLPs are equally accommodated where appropriate; the underwriting treatment is similar but personal income evidence and tax position are weighed differently.',
      },
      {
  ...
  "semi-commercial-mortgage": {
    ...
    metaTitle: "Semi-Commercial Mortgage Cambridge | Specialist Broker",
    metaDescription:
      "Mixed-use shop-with-flat finance for Cambridge parades. Up to 75% LTV, blended cover ~145%, interest rates 6.5 to 8.5% pa, limited company SPV supported. InterBay Commercial, Shawbrook, LendInvest. Indicative terms in 48 hours.",
    hero: {
      eyebrow: "Up to 75% LTV · Blended cover",
      h1: "Semi-Commercial Mortgage Cambridge",
      lede:
        "Single-facility finance for property where the residential element is at least 40% of total floorspace: the shop-with-flat archetype that defines Cambridge inner-ring parades. Up to 75% loan-to-value, blended cover ~145%, interest rates 6.5 to 8.5% pa, 5 to 25 year repayment terms. Active across Mill Road, Romsey, Petersfield, Newnham and the Chesterton parade.",
      metrics: [
        { label: "LTV", value: "Up to 75%" },
        { label: "Rate", value: "From 6.5% pa" },
        { label: "Term", value: "5 to 25 years" },
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { label: "3. Credit pack", detail: "Lease pack, AST pack, property file, borrower SPV (or individual) pack. InterBay and Shawbrook want clean tenancy evidence." },
    ...
    whoItsFor: {
      h2: "Buyer profiles for the shop-with-flat archetype",
      items: [
        "Investors buying classic shop-with-flat-above stock on Mill Road, Romsey high street and Chesterton parade",
        "Petersfield and Newnham investors with high-value upper-floor residential above ground-floor retail or professional services",
        "Limited company SPV landlords refinancing semi-commercial holdings off maturing 5-year fixes",
        "Portfolio investors with a mix of pure commercial and semi-commercial assets across the CB postcodes",
        "Cambridge F&B operators with operator flat above (where the operator lives in the flat)",
        "Mixed-use conversion deals where consent is for ground-floor retail plus four to six flats above (Mill Road, central Cambridge)",
        "First-time semi-commercial investors moving up from a residential buy-to-let portfolio",
        "Retiring landlords selling individual semi-commercial assets to incoming Cambridge portfolio investors",
      ],
    },
    localAngle: {
      h2: "Active Cambridge semi-commercial parades and lender behaviour",
      body: 'Semi-commercial is a deep, active product across Cambridge. The classic inner-ring parades, <a href="/property-types/semi-commercial" class="text-secondary font-medium hover:underline">Mill Road (CB1), Romsey Town, Petersfield, Newnham and the Chesterton parade</a>, run on shop-with-flat-above stock backed by exceptionally durable residential demand from the ~24,000 University of Cambridge students, ~30,000 Anglia Ruskin students and the post-doc and NHS / Addenbrooke\'s workforce. Lot sizes are typically £400K to £1.2M for a single parade unit, often £1.5M+ for a Mill Road four-unit run with multiple flats above. Gross blended yields run firmer than the regional UK average given the city\'s tight residential market: typically 6.5 to 8% blended in central CB1 and CB2, slightly wider on the Chesterton and Cherry Hinton fringe. The Mill Road sub-market is distinctive: independent F&B and retail operators with long trading history sit alongside high-demand residential lets, producing reliable blended income. Lender appetite is strong: <strong>InterBay Commercial</strong>, <strong>Shawbrook</strong>, <strong>LendInvest</strong> and <strong>Cynergy Bank</strong> all actively quote on Cambridge semi-commercial deals, with the clearing banks reserving their cheaper pricing for owner-occupier rather than investment versions of the product. Cambridge & Counties Bank engages selectively on local stock.',
    },
    faqs: [
      {
      ...
      {
        question: "Which lenders are most active for Cambridge shop-with-flat finance?",
        answer:
          '<strong>InterBay Commercial</strong>, <strong>Shawbrook</strong>, <strong>LendInvest</strong> and <strong>Cynergy Bank</strong> lead on the specialist side. Each has a slightly different LTV, covenant and minimum-loan profile. Cambridge & Counties Bank also engages on local semi-commercial stock. Interest rates from 6.5% pa for clean stock.',
      },
      {
        question: "Can I get 75% loan-to-value on a Cambridge semi-commercial?",
        answer:
      ...
      },
      {
        ...
        answer:
          'Stamp duty land tax follows non-residential rates on a genuinely mixed-use property: 0% to £150K, 2% £150K to £250K, 5% above. On a £900K Mill Road shop-with-three-flats purchase the SDLT bill is around £34,500. That is materially cheaper than the residential SDLT (with the 3% additional-property surcharge) that would apply to a pure residential equivalent, one of the structural reasons investors favour semi-commercial.',
      },
      {
        question: "Can I use a limited company to hold the asset?",
        answer:
          'Yes, limited company SPV is the standard structure for new semi-commercial acquisitions across Cambridge. Specialist desks like InterBay are entirely comfortable with new SPV borrowers (with director personal guarantee). Existing trading limited companies, LLPs and individual investors are equally accommodated.',
      },
    ],
  },
  ...
  "portfolio-refinance": {
    ...
    metaTitle: "Commercial Portfolio Refinance Cambridge | Specialist Broker",
    metaDescription:
      "Single-facility portfolio refinancing for Cambridge investors carrying five or more commercial assets. Blanket-charge or aggregated structures, £2M to £20M typical, LTV to 70%, interest rates from 6.5% pa. Shawbrook, InterBay Commercial, Cynergy Bank.",
    hero: {
      eyebrow: "5+ assets · Single facility",
      h1: "Commercial Portfolio Refinance Cambridge",
      lede:
    ...
    whatItIs: {
      ...
      body: [
        ...
        'Aggregate ICR is tested across the portfolio at <strong>140 to 150%</strong> stressed at a notional interest rate 1 to 2% above pay rate. Tenant concentration matters: if more than 20 to 25% of income comes from a single tenant, lenders may price wider or cap loan-to-value. Sector concentration matters similarly, though life sciences concentration in a Cambridge portfolio is treated more constructively than most given the structural demand picture. Geographic concentration in Cambridge plus the surrounding Cambridgeshire ring (South Cambridgeshire, East Cambridgeshire, Huntingdonshire) is fine; lenders are comfortable with regional clustering when the borrower demonstrates local market knowledge.',
        'Most Cambridge portfolio refinancing today is taken out by <strong>limited company</strong> holding structures (single corporate-level entity, or a topco with subsidiary SPVs), partly for tax efficiency, partly because lenders increasingly prefer a clean corporate counterparty for £5M+ facilities. Stamp duty land tax does not apply on refinancing (no transfer of beneficial ownership), which is part of what makes consolidation maths work even when ERCs on existing facilities have to be modelled in. Portfolio refinancing sits outside FCA regulation. <em>Indicative case seed:</em> a Cambridge investor with seven Romsey and Mill Road semi-commercial blocks plus a single CSP-fringe office investment, £8.6M total value, refinanced into a single aggregated facility at 65% LTV (£5.6M) at around 6.8% pa.',
      ],
    },
    howItWorks: {
    ...
    whoItsFor: {
      ...
      items: [
        "Cambridge-based commercial landlords carrying 5+ investment properties under different lenders",
        "Multi-asset HMO and semi-commercial blocks across Romsey, Petersfield and Mill Road being consolidated under one corporate holding",
        "Life sciences investor portfolios holding lab and office investment around Cambridge Science Park, CBC and Granta Park",
        "Mixed semi-commercial books spanning Mill Road, Chesterton, Newnham and the Cherry Hinton fringe",
        "Investors approaching multiple maturity dates on individual fixes within a 24-month window",
        "Family offices and professional investor LLPs holding mixed commercial portfolios across Cambridge and South Cambridgeshire",
    ...
    localAngle: {
      h2: "Active Cambridge portfolio desks and typical book composition",
      body: '<strong>Shawbrook</strong>, <strong>InterBay Commercial</strong> and <strong>Cynergy Bank</strong> are the most active portfolio lenders for the £2M to £20M Cambridge bracket. <strong>Lloyds</strong> and <strong>NatWest</strong> commercial banking compete on the prime end, with East Anglia corporate desks running coverage out of regional offices. Cambridge & Counties Bank holds a particularly defensible position on local portfolios in its East Anglia home market. The typical Cambridge portfolio profile we see has two distinct flavours: the <strong>life sciences investor book</strong> (a handful of lab and office investments around the CSP, CBC and Granta Park clusters, often with strong-covenant FRI leases and longer WAULTs); and the <strong>HMO / semi-commercial inner-ring book</strong> (multi-asset blocks across Mill Road, Romsey, Petersfield and Chesterton, blended yield, durable residential demand from the universities and the Addenbrooke\'s workforce). Refinancing volume is particularly strong on portfolios with original draws from 2019 to 2021 where current valuations support a meaningfully better consolidated LTV than the original. Pricing currently <strong>6.5 to 8.5% pa</strong> across portfolio facilities. See also our <a href="/services/commercial-remortgage" class="text-secondary font-medium hover:underline">single-asset commercial remortgage</a> route for smaller books.',
    },
    faqs: [
      {
  ...
  "trading-business-mortgage": {
    ...
    metaTitle: "Trading-Business Commercial Mortgage Cambridge | Specialist Broker",
    metaDescription:
      "Sector-specialist commercial mortgages for Cambridge operators: hotels on Newmarket Road, tourism F&B, King\'s Parade hospitality, dental, care homes, day nurseries. EBITDA-driven underwriting, LTVs 60 to 70%, interest rates 7.0 to 9.0% pa, 15 to 25 year repayment terms. Shawbrook, Cynergy Bank, InterBay Commercial.",
    hero: {
      eyebrow: "Sector-specialist · 60-70% LTV",
      h1: "Trading Business Mortgage Cambridge",
      lede:
    ...
    whatItIs: {
      ...
      body: [
        ...
        'Underwriting is sector-specific and depends entirely on the property type. <strong>Hotels</strong>: occupancy, ADR (average daily rate), RevPAR, brand affiliation, location. The Newmarket Road hotel cluster, the King\'s Parade and Trinity Street tourist spine, and the central Cambridge boutique segment all run on different lender profiles. <strong>Pubs and bars</strong>: barrelage, EBITDA, beer-tie status, license type, trading record. <strong>Care homes</strong>: CQC rating, occupancy, weighted-average bed value, fee rates (council vs private mix). <strong>Dental practices</strong>: NHS UDA contract value, private fee mix, principal vs associate structure, surgery count. <strong>Day nurseries</strong>: Ofsted rating, registered places, occupancy, fee structure. <strong>Wedding and banqueting venues</strong>: forward booking pipeline, average spend per event, accounts seasonality. Cambridge tourism F&B is unusually well-supported by the ~8 million annual visitors to the city.',
        'Loan-to-value runs <strong>60 to 70%</strong> typically, lower than pure investment because the asset value is sector-locked and harder to repurpose if the business fails. Term <strong>15 to 25</strong> years; interest rates <strong>7.0 to 9.0% pa</strong> reflecting the specialist underwrite. Different sub-sectors route to different lenders, and getting the right desk first time is the broker\'s entire job. Most trading-business mortgages are taken out by a limited company trading entity with personal guarantee from the operating principal, and most fall outside FCA-regulated mortgage rules because they finance business premises, not residential property.',
        'Stamp duty land tax on a trading-business purchase follows commercial rates (0% to £150K, 2% to £250K, 5% above), and where a deal is structured as a share purchase of an existing operating limited company rather than an asset purchase, SDLT can be deferred or partly avoided. We work alongside the buyer\'s tax adviser on the structure before submission. Refinancing an existing trading-business mortgage (typically off a maturing 5-year fix) is a frequent reason to re-engage; current rate environment is creating refinancing demand particularly on hotel and care home operator books across Cambridge. <em>Indicative case seed:</em> a 32-bed Newmarket Road hotel with stable occupancy and ADR, EBITDA cover comfortably above 1.8x, purchased at £2.8M with a £1.85M facility at 65% LTV around 7.5% pa.',
      ],
    },
    howItWorks: {
      ...
      steps: [
        ...
        { label: "2. Specialist lender shortlist", detail: "Sector dictates lender. Care and dental: Shawbrook and Cynergy Bank. Pubs and bars: Cynergy Bank plus licensed-trade specialist desks. Hotels: specialist hospitality desks plus selective clearing-bank engagement on larger Cambridge tourism deals." },
    ...
    whoItsFor: {
      ...
      items: [
        "Hotel operators in the Newmarket Road cluster, central boutique segment and on the King\'s Parade / Trinity Street tourist spine",
        "Cambridge tourism F&B and restaurant operators on Mill Road, the central Lanes and the King\'s Parade hospitality strip",
        "Dental and primary-care principals (Trumpington Road clinics, Mill Road and Chesterton dental practices, Addenbrooke\'s-flank private clinics)",
        "Care home operators across the wider Cambridgeshire commuter belt (Cherry Hinton, Trumpington, Newnham, Histon and Impington)",
        "Day nursery operators (Newnham, Trumpington, Chesterton, Histon, Cherry Hinton suburban belt)",
        "Pub and bar operators across central Cambridge, Mill Road and the Newmarket Road corridor",
        "Banqueting and wedding venue operators including converted barns and listed-building venues in the surrounding villages",
        "Independent restaurant and gastropub operators across Mill Road, Romsey and the city centre",
      ],
    },
    localAngle: {
      h2: "Sub-sector clusters and lender behaviour across the Cambridge market",
      body: 'Cambridge runs one of the more distinctive trading-business commercial mortgage flows in the East of England, driven by the city\'s ~8 million annual tourism visitor count, the University of Cambridge / Anglia Ruskin combined ~54,000-student economy, and the dense NHS / Cambridge University Hospitals NHS Trust workforce around Addenbrooke\'s and the Cambridge Biomedical Campus. The Newmarket Road hotel cluster, the central boutique segment, and the King\'s Parade / Trinity Street tourist spine support unusually firm hotel EBITDA cover and route primarily through specialist hospitality lenders. The <a href="/property-types/leisure-hospitality" class="text-secondary font-medium hover:underline">Cambridge tourism F&B sub-market</a> on Mill Road, the Lanes and King\'s Parade is well-supported by visitor footfall. The <a href="/property-types/healthcare-care-home" class="text-secondary font-medium hover:underline">dental and primary-care cluster</a> around Trumpington Road, the Addenbrooke\'s flank, Mill Road and Chesterton is similarly deep, with clearing bank healthcare desks at <strong>Lloyds</strong> and <strong>NatWest</strong> competitive on principal buy-outs; <strong>Shawbrook</strong> and <strong>Cynergy Bank</strong> hold significant care-home and dental books in the East of England. Day nurseries cluster across Newnham, Trumpington, Chesterton, Histon and Cherry Hinton, with specialist desks providing the core appetite. Pub trading-business deals across central Cambridge route primarily through <strong>Cynergy Bank</strong> and licensed-trade specialist desks; Cambridge & Counties Bank engages selectively on local trading-business cases. Refinancing volume from 2019 to 2021 vintage operator books is particularly strong in mid-2026.',
    },
    faqs: [
      {
        question: "Can I buy a Cambridge hotel on a trading-business mortgage?",
        answer:
          'Yes. Hotel mortgages are typically structured at 60 to 70% loan-to-value, term 15 to 20 years, interest rate 7.0 to 9.0% pa. Lender appetite depends heavily on occupancy, ADR and RevPAR, brand affiliation and trading record. Specialist hospitality desks dominate the Newmarket Road cluster and central boutique segment; clearing banks engage selectively on larger Cambridge tourism deals.',
      },
      {
  ...
  "commercial-remortgage": {
    ...
    metaTitle: "Commercial Remortgage Cambridge | Specialist Broker",
    metaDescription:
      "Refinancing existing commercial debt across Cambridge. End-of-fix transitions, capital-raise refinancing, ERC modelled. Loan-to-value to 75%, interest rates from 6.0% pa, repayment terms 5 to 25 years. NatWest, Lloyds, Barclays, Santander, Shawbrook.",
    hero: {
      eyebrow: "End-of-fix · Capital raise",
      h1: "Commercial Remortgage Cambridge",
      lede:
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { label: "4. Application packaging", detail: "Standard credit pack: accounts, leases (if investment), property file, borrower SPV / limited company pack. Cleaner than a fresh acquisition." },
    ...
    whoItsFor: {
      ...
      items: [
        ...
        "Commercial investment landlords whose properties have appreciated since acquisition (post-2022 Cambridge investment portfolios particularly)",
        "Lab and life sciences investment refinance off 2019 to 2021 vintage facilities around the CSP and CBC clusters",
    ...
    localAngle: {
      h2: "Why current Cambridge refinancing volume is high",
      body: 'With Bank of England base-rate trajectory through 2026 looking flatter than the 2023 to 2024 cycle, refinancing demand across Cambridge is strong, particularly on the post-2022 refinance wave on Cambridge investment portfolios and on lab investment refinance around the Cambridge Science Park and Cambridge Biomedical Campus clusters. <strong>Shawbrook</strong>, <strong>Cynergy Bank</strong> and <strong>InterBay Commercial</strong> are the most aggressive challenger desks competing for clean Cambridge remortgage business. <strong>NatWest</strong>, <strong>Lloyds</strong> commercial banking and <strong>Barclays</strong> all run dedicated remortgage propositions on the high-street side, with East Anglia corporate relationship teams active across the Hills Road, Sidney Street and Cambridge North office corridors. <strong>Santander</strong> is competitive on the £2M+ end. Cambridge & Counties Bank holds a structural position on local refinance business in its home market. Refinancing demand is concentrated in lab and office investment around CSP and the CBC fringe, professional services freeholds on Hills Road and Sidney Street, and central retail / mixed-use around Sidney Street, Grand Arcade and Lion Yard where rents have grown faster than pure capital values. Where the existing first charge is on a competitive 2019 to 2021 legacy rate (3.5 to 4.5%) and breaking it would cost more than the saving, see also our <a href="/services/second-charge-commercial-mortgage" class="text-secondary font-medium hover:underline">second-charge commercial mortgage</a> route.',
    },
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          'Sometimes, if the rate saving over the remaining fix outweighs ERC plus new arrangement fees. We model the break-even precisely. On a £1.5M facility, a 1.5% interest rate saving over 3 years is £67.5K; a 3% ERC is £45K. So a 3% ERC is worth breaking. Lower spreads need careful modelling.',
      },
      {
  ...
  "commercial-bridge-to-let": {
    ...
    metaTitle: "Commercial Bridging Loan Cambridge | Specialist Broker",
    metaDescription:
      "Short-term commercial bridge-to-let finance in Cambridge. 12 to 24 month bridge funding acquisition plus refurb or re-let, with agreed exit onto a long-term commercial mortgage. £500K to £5M, LTV to 70%, bridge interest 0.75 to 1.10% pm. LendInvest, Shawbrook.",
    hero: {
      eyebrow: "12-24m bridge · Clean term-out",
      h1: "Commercial Bridging Loan Cambridge",
      lede:
    ...
    whoItsFor: {
      ...
      items: [
        "Development exit on CBC-fringe converted offices being re-let to life sciences and professional services tenants",
        "Central Cambridge HMO conversion bridges where consent supports ground-floor commercial and multiple upper-floor lets",
        "Investors buying vacant central Cambridge office floorplates for refurbishment and re-letting around Sidney Street and Hills Road",
        "Mill Road and Romsey semi-commercial conversion deals (Class E to retail-plus-residential)",
        "Cherry Hinton and Chesterton industrial unit acquisitions from receivers",
        ...
        "Change-of-use conversion deals through Greater Cambridge Shared Planning (B8 to Class E, B-class to mixed commercial)",
      ],
    },
    localAngle: {
      h2: "Active Cambridge bridge-to-term value-add territory",
      body: '<strong>LendInvest</strong> and <strong>Shawbrook</strong> are the most active commercial bridging desks for Cambridge £500K to £5M deals; <strong>InterBay Commercial</strong> takes selected cases on the larger end. Particular value-add territories in 2026: <a href="/areas/" class="text-secondary font-medium hover:underline">CBC-fringe converted office floorplates</a> being re-let to life sciences and professional services tenants as development exits; central Cambridge HMO conversion bridges where Greater Cambridge Shared Planning has supported ground-floor commercial plus upper-floor residential conversion; vacant Sidney Street, Hills Road and St Andrew\'s Street office floorplates being refurbished for re-letting; Mill Road and Romsey semi-commercial conversions; Cherry Hinton and Chesterton industrial units bought from receivers; and the meaningful change-of-use pipeline running through the Greater Cambridge planning authority (B8 industrial to mixed commercial, Class E to leisure, office to flats). Auction-bought assets at regional rooms are a regular driver of bridge enquiries: the 28-day completion clock simply cannot be met by term-mortgage process.',
    },
    faqs: [
      {
        question: "How quickly can a Cambridge commercial bridge complete?",
        answer:
      ...
      {
        question: "What interest rate should I expect on a Cambridge bridge-to-let?",
        answer:
  ...
  "second-charge-commercial-mortgage": {
    ...
    metaTitle: "Second-Charge Commercial Mortgage Cambridge | Specialist Broker",
    metaDescription:
      "Subordinated commercial finance behind your existing first-charge facility. Keep the legacy interest rate intact, raise £100K to £2M against the same Cambridge asset. Combined LTV to 75%, interest rates 10 to 14% pa. InterBay Commercial, LendInvest, specialist private credit.",
    hero: {
      eyebrow: "Behind senior · £100K-£2M",
      h1: "Second-Charge Commercial Mortgage Cambridge",
      lede:
    ...
    howItWorks: {
      ...
      steps: [
        ...
        { label: "5. Valuation and intercreditor", detail: "RICS Red Book valuation. Deed of priority / intercreditor agreement between senior and second-charge lenders. Adds 1 to 2 weeks vs first-charge process." },
    ...
    whoItsFor: {
      ...
      items: [
        "Cambridge investor portfolios raising capital for onward acquisition without disturbing portfolio facility (capital raise on Cambridge investor portfolios)",
        "Central commercial freehold owners executing equity release without breaking a competitive legacy first charge",
    ...
    localAngle: {
      h2: "When subordinated debt is doing real work in the Cambridge market",
      body: '<strong>InterBay Commercial</strong>, <strong>LendInvest</strong> and select private-credit desks are the active second-charge commercial lenders for Cambridge. The product sees most use on two distinct Cambridge profiles. First, <strong>capital raise on Cambridge investor portfolios</strong>: an investor with a cheap legacy first charge on a Mill Road semi-commercial block or a CSP-adjacent office investment needs equity for the next acquisition, and the second-charge route preserves the original cheap rate. Second, <strong>central commercial freehold equity release</strong>: an asset-rich owner of a Sidney Street, Hills Road or St Andrew\'s Street freehold raises capital for business growth without breaking the senior. Combined first plus second LTV usually capped at 70 to 75% on owner-occupier; investment assets sometimes flex to 80% combined. On a £2M owner-occupied Hills Road professional services freehold with a £800K legacy first charge at 4% (with 3 years left), a £600K second-charge at 12% costs less in absolute terms than a full refinancing of the £1.4M total at 7.5% with a £40K ERC, by around £24K over three years. We run the same comparison for Mill Road semi-commercial investors, Cambridge Science Park-adjacent lab investors and central retail freeholders before recommending. See also our <a href="/services/commercial-remortgage" class="text-secondary font-medium hover:underline">commercial remortgage</a> route where the whole-stack refinancing actually beats the second-charge maths.',
    },
    faqs: [
      {
      ...
      },
      {
        ...
        answer:
          'Subordinated risk. In a default scenario the first-charge lender is repaid in full from the asset before the second-charge lender sees anything. The interest rate reflects that. <strong>10 to 14% pa</strong> is the typical Cambridge second-charge range, against 6.5 to 9.0% pa for a comparable first-charge.',
      },
      {
        question: "When does second-charge make sense versus full refinancing?",
        answer:
          'When the legacy first-charge rate is materially below current market and the ERC to break is significant. Run the numbers: if (rate saving x remaining term) < (ERC + new arrangement fees), second-charge usually wins. We model both routes and recommend the cheaper all-in.',
      },
      {
