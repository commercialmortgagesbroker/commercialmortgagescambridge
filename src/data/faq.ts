...
export const faqItems: FAQItem[] = [
  ...
  {
    question: "How long does it take to arrange a Cambridge commercial mortgage?",
  ...
  {
    question: "Which Cambridge areas do you cover?",
    slug: "which-areas-do-you-cover",
    answer: `We arrange commercial mortgages across the full city and Greater Cambridge area and the wider Cambridgeshire footprint. Twelve area pages cover the active commercial sub-markets: Cambridge City Centre (CB1 CBD office, retail, mixed-use), Trumpington South (regeneration, mixed-use refinance), Newmarket Road (Urban Village creative offices, listed mill stock), Cambridge Science Park (Mill Road semi-commercial, HMO, leisure), Petersfield (CB1 HMO concentration), Chesterton (retail park, Chesterton Road industrial), Petersfield (CB1 independent retail and dental cluster), Cherry Hinton (premium care home cluster, Cherry Hinton Road retail), Chesterton (Chesterton Road independent retail and professional services), Romsey (South Cambridge light industrial, Class E leisure), Romsey (CB3 secondary retail and mixed-use), Cherry Hinton (Cambridge Research Park Waterbeach industrial, Newnham Road retail). Beyond Cambridge itself we routinely fund deals in Peterborough, Huntingdon, Saffron Walden, Ely, Histon and the wider East of England commuter belt from the same Cambridge-based lender panel.`,
    relatedLinks: [
